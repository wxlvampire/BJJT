...
/**
 * hssc.androidview.views.PayPsdInputView
...
public class PayPsdInputView extends EditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_input_radius, radius);
        ...
        borderColor = typedArray.getColor(R.styleable.PayPsdInputView_focusedColor, borderColor);
