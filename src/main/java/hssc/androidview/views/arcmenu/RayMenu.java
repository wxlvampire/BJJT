...
public class RayMenu extends RelativeLayout {
	...
	private RayVerticalLayout mRayVLayout;
	...
	public void setOnItemClickListener(final OnItemClickListener onItemClickListener) {
		mRayVLayout.setOnItemClickListener(onItemClickListener);

	}

	public void setmRayLayout(RayLayout mRayLayout) {
		this.mRayLayout = mRayLayout;
	}

	public void setmRayVLayout(RayVerticalLayout mRayVLayout) {
		this.mRayVLayout = mRayVLayout;
	}
	...
	public void setMargin(int margin) {
		this.margin = margin;
		mRayVLayout.setPaddingBottom(margin);
	}
...
//		mRayLayout = (RayLayout) findViewById(R.id.item_layout);
		mRayVLayout = (RayVerticalLayout) findViewById(R.id.item_layout);
		...
		controlLayout.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					mHintView.startAnimation(createHintSwitchAnimation(mRayVLayout.isExpanded()));
//					mRayLayout.switchState(false);
					mRayVLayout.switchState(true);
				}
				return false;
			}
		});
