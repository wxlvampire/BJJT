...
/**
 * © 2012 amsoft.cn 名称：InnerViewPager.java 
...
public class InnerViewPager extends ViewPager {
	...
	private boolean parentTouchable;
	...
	public void setParentTouchable(boolean parentTouchable) {
		this.parentTouchable = parentTouchable;
		Log.e("parentTouchable","parentTouchable--"+parentTouchable);
	}
	...
	class YScrollDetector extends SimpleOnGestureListener {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
			Log.e("onScroll","parentTouchable--"+parentTouchable);
