...
import hssc.androidview.utils.DisplayUtil;
import hssc.androidview.views.marqueeview.OnItemClickListener;

/**
 * hssc.androidview.views.MarqueeView
...
public class MarqueeView extends ViewFlipper {
    ...
    private TextView createTextView(String text, final int position) {
