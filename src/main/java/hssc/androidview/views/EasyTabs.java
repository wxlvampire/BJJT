...
public class EasyTabs extends HorizontalScrollView {
    ...
    public InnerViewPager.OnPageChangeListener delegatePageListener;

    private LinearLayout tabsContainer;
    private InnerViewPager pager;
    private LazyViewPager lazyViewPager;
    private LazyPagerListener lazyPagerListener = new LazyPagerListener();
    ...
    private int mMyUnderlinePadding = 15;
    ...
    public EasyTabs(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.indicatorHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, indicatorHeight, dm);
        this.underlineHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, underlineHeight, dm);
        ...
        this.tabTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, tabTextSize, dm);

        // get system attrs (android:textSize and android:textColor)

        TypedArray a = context.obtainStyledAttributes(attrs, ATTRS);
        this.tabTextSize = a.getDimensionPixelSize(1, tabTextSize);
        ...
        this.tabTextSize = a.getDimensionPixelSize(R.styleable.EasySlidingTabs_easyTabTextSize,tabTextSize);
        a.recycle();
    ...
    private void setTabsValue() {
        ...
        this.setUnderlineHeight((int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_PX, this.underlineHeight, dm));
        // set tab indicator height
        this.setIndicatorHeight((int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_PX, this.indicatorHeight, dm));
        // set tab text size
        this.setTextSize((int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_PX, this.tabTextSize, dm));
     ...
     * @param pager
     */
    public void setViewPager(InnerViewPager pager) {
        // TODO tmp strategy
    ...
    public void setViewPager(LazyViewPager pager) {
        ...
        this.lazyViewPager = pager;
        this.selectedPosition = pager.getCurrentItem();
        if (pager.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have adapter instance.");
        }
        pager.setOnPageChangeListener(lazyPagerListener);
        this.notifyDataSetChanged();
        this.setTabsValue();
    }
     ...
     * @param listener
     */
    public void setOnPageChangeListener(InnerViewPager.OnPageChangeListener listener) {
...
//        this.tabCount = pager.getAdapter().getCount();
        if (titleArray != null) {
            this.tabCount = titleArray.length;
        }
        Log.e("tab-----","---tabCount----"+tabCount);

        for (int i = 0; i < this.tabCount; i++) {
//            TabsTitleInterface weChatTabTitleInterface = (TabsTitleInterface) adapter;

//            Log.e("测试------------",weChatTabTitleInterface.getTabTitle(i)+"????");
            addTextTab(i, new SpannableString(titleArray[i]),
                    0,
                    0,
                    0,
                   0);
...
//                } else {
//                    Log.e("titie-----------'", adapter.getPageTitle(i).toString()+"!!!");
...
//            }
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                EasyTabs.this.currentPosition = EasyTabs.this.pager.getCurrentItem();
                scrollToChild(EasyTabs.this.currentPosition, 0);
            }
        });
    }
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                EasyTabs.this.pager.setCurrentItem(position);
            }
        });

//        You can set padding
//        if (position == 0){
//            tab.setPadding(AppUtils.dip2px(context,15), 0, AppUtils.dip2px(context,19), 0);
//        }else {
//            tab.setPadding(AppUtils.dip2px(context,0), 0, AppUtils.dip2px(context,19), 0);
//        }

        tab.setPadding(AppUtils.dip2px(context,15), 0, AppUtils.dip2px(context,15), 0);
        ...
        if (this.defaultTabLayoutParams == null) {
            ...
            this.defaultTabLayoutParams = new LinearLayout.LayoutParams(AppUtils.getWidth(context)/tabCount, ViewGroup.LayoutParams.MATCH_PARENT);
        }
...
//            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currentPositionOffset > 0f && this.currentPosition < this.tabCount - 1) {
            nextTab = this.tabsContainer.getChildAt(this.currentPosition + 1);
        ...
        if (this.indicatorDrawable != null) {
            ...
            canvas.drawRect(lineLeft + mMyUnderlinePadding, height - this.indicatorHeight,lineRight -mMyUnderlinePadding , height, this.rectPaint);
        }
    ...
    private class PageListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            EasyTabs.this.currentPosition = position;
            EasyTabs.this.currentPositionOffset = positionOffset;

            View view = EasyTabs.this.tabsContainer.getChildAt(position);
            if (view == null) {
                return;
            }
            ...
            if (EasyTabs.this.delegatePageListener != null) {
                EasyTabs.this.delegatePageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                scrollToChild(EasyTabs.this.pager.getCurrentItem(), 0);
            }

            if (EasyTabs.this.delegatePageListener != null) {
                EasyTabs.this.delegatePageListener.onPageScrollStateChanged(state);
            }
        }

        @Override
        public void onPageSelected(int position) {
            EasyTabs.this.selectedPosition = position;
            updateTabStyles();
            if (EasyTabs.this.delegatePageListener != null) {
                EasyTabs.this.delegatePageListener.onPageSelected(position);
            }
        }

    }

    private class LazyPagerListener implements LazyViewPager.OnPageChangeListener {
        @Override
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            EasyTabs.this.currentPosition = position;
            EasyTabs.this.currentPositionOffset = positionOffset;
