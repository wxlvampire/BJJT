...
public class InstallUtil {
    ...
    public static final int install(Context context, String filePath) {
        // String chmodCmd = "chmod 666 " + filePath;
        // try {
        // Runtime.getRuntime().exec(chmodCmd);
        // } catch (Exception e) {
        // }
        if (InstallUtil.isSystemApplication(context) || ShellUtils.checkRootPermission()) {
     ...
     * @param filePath
     *          file path of package
     *         same to {@link PackageManager}.INSTALL_*
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        Log.e(TAG,
                new StringBuilder().append("installSilent successMsg:").append(commandResult.successMsg).append(", ErrorMsg:")
    ...
    public static boolean uninstallNormal(Context context, String packageName) {
        ...
        Intent i = new Intent(Intent.ACTION_DELETE, Uri.parse(new StringBuilder(32).append("package:").append(packageName)
                .toString()));
        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(i);
        return true;
    ...
    public static void startInstalledAppDetails(Context context, String packageName) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            ...
            intent.putExtra((sdkVersion == Build.VERSION_CODES.FROYO ? "pkg" : "com.android.settings.ApplicationPkgName"),
                    packageName);
        }
    ...
    public static boolean isAppleanRun(Context context,String packageName) {
