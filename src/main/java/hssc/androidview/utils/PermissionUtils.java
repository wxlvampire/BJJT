...
import hssc.androidview.utils.interfaces.PermissionGrant;
...
public class PermissionUtils {
    ...
    public static final int CODE_START_SETTING = CODE_WRITE_EXTERNAL_STORAGE+1;
    ...
    public static void requestPermission(final Activity activity, final int requestCode, PermissionGrant permissionGrant) {
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission)) {
                ...
                startPermissionActivity(CODE_START_SETTING,activity);
...
//            Toast.makeText(activity, "opened:" + requestPermissions[requestCode], Toast.LENGTH_SHORT).show();
    ...
    //打开权限设置界面
    private static void startPermissionActivity(int requestCode,Activity activity){
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "should open those permission",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {ActivityCompat.requestPermissions(activity, shouldRationalePermissionsList.toArray(new String[shouldRationalePermissionsList.size()]),
                                    CODE_MULTI_PERMISSION);
                            Log.d(TAG, "showMessageOKCancel requestPermissions");
                        }
                    });
